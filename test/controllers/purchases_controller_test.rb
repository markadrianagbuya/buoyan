...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { package_id: @purchase.package_id, student_id: @purchase.student_id } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { package_id: @purchase.package_id, student_id: @purchase.student_id } }
